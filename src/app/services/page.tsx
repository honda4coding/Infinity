...
const mainData = [
  ...
  },
  {
    ...
    showPopup: true,
    imgPop:["https://i.ibb.co/yy1RyY8/Marine-ship-CFD-Msc-Cradle-Ansys-Fluent-Siemens-Star-ccm.webp",
    "https://i.ibb.co/JB6gxNz/photo-1585713181935-d5f622cc2415.webp"],
    textPop:[ "Class Hull and Machinery certification",
...
const Services: React.FC = () => {
  ...
  const currentService = mainData.find((service) => service.title === activeTab);
